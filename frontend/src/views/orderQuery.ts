...
export const defaultOrderFilter: OrderFilterState = { orderNo: '', storeId: undefined, status: undefined, destinationCountry: '', channelId: '', trackingNo: '', createdFrom: '', createdTo: '', sortBy: 'createdAt', sortDirection: 'DESC', page: 1, pageSize: 20 }
...
export function parseOrderQuery(query: LocationQuery): OrderFilterState {
  const status = one(query.status) as OrderStatus
