...
class ShipmentOrderApplicationServiceTest {
 ...
 private ShipmentOrder order(){return new ShipmentOrder(88L,7L,"SO1","key",3L,99L,4L,"DRAFT","CN","US",new BigDecimal("1.2"),new BigDecimal("20"),new BigDecimal("20"),new BigDecimal("20"),new BigDecimal("1.6"),new BigDecimal("2"),new BigDecimal("12"),"USD",LocalDateTime.of(2026,8,11,8,0));}
