...
public interface BillingMapper {
    ...
    long countBatches(@Param("tenantId") Long tenantId, @Param("providerId") Long providerId, @Param("status") String status);
    List<BillImportBatch> findBatches(@Param("tenantId") Long tenantId, @Param("providerId") Long providerId, @Param("status") String status, @Param("offset") int offset, @Param("limit") int limit);
    ...
    int finishBatch(@Param("tenantId") Long tenantId, @Param("batchId") Long batchId, @Param("total") int total, @Param("success") int success, @Param("failure") int failure, @Param("status") String status, @Param("version") Long version);
    long countDetails(@Param("tenantId") Long tenantId, @Param("batchId") Long batchId, @Param("status") String status);
    List<BillDetail> findDetails(@Param("tenantId") Long tenantId, @Param("batchId") Long batchId, @Param("status") String status, @Param("offset") int offset, @Param("limit") int limit);
    ...
    long countReconciliations(@Param("tenantId") Long tenantId, @Param("orderId") Long orderId, @Param("status") String status);
    List<ReconciliationRecord> findReconciliations(@Param("tenantId") Long tenantId, @Param("orderId") Long orderId, @Param("status") String status, @Param("offset") int offset, @Param("limit") int limit);
