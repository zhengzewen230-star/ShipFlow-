...
public class LogisticsMasterController {
    ...
    @GetMapping("/logistics-channels/{channelId}/price-rules") public ApiResponse<java.util.List<PublishedPriceRule>> priceRules(@PathVariable Long channelId) { return ApiResponse.success(service.publishedPriceRules(channelId)); }
    @GetMapping("/logistics-channels/{channelId}/price-rules/{priceRuleId}") public ApiResponse<PublishedPriceRule> priceRule(@PathVariable Long channelId, @PathVariable Long priceRuleId) { return ApiResponse.success(service.publishedPriceRule(channelId, priceRuleId)); }
