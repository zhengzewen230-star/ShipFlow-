-- ShipFlow shipflow_http_test controlled copy of database/migrations/V002__add_api_support_tables.sql.
...
-- IF NOT EXISTS is intentional: 01_schema_empty_target.sql already contains these two current baseline tables.
