-- ShipFlow shipflow_http_test controlled initialization copy.
-- Execute only through a client connection whose selected database is shipflow_http_test.
-- This file never creates, selects, or switches databases. It is for an empty target only.
-- Source: database/schema.sql. The destructive DROP TABLE statements are isolated as comments below.
SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS audit_log;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS auth_refresh_session;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS api_idempotency_record;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS reconciliation_record;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS bill_detail;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS bill_import_batch;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS warehouse_outbound_record;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS claim_record;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS exception_case;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS tracking_event;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS fee_adjustment;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS warehouse_measurement;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS shipment_item;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS shipment_address;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS shipment_package;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS shipment_quote_snapshot;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS shipment_order;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS quote;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS price_rule_tier;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS price_rule;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS logistics_channel_service_country;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS logistics_channel;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS logistics_provider;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS sys_role_permission;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS sys_user_role;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS sys_permission;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS sys_role;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS sys_user;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS merchant_store;
-- ISOLATED DESTRUCTIVE SOURCE STATEMENT (not executed): DROP TABLE IF EXISTS tenant;
